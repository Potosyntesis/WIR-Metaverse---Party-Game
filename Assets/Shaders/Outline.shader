    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 Frag(Varyings i) : SV_Target
			{
				...
				// calculating the texture coordinates in pixels directly diagonal from where you're looking
				...
				float normalThreshold01 = saturate((NdotV - _DepthThreshold) / (1 - _DepthThreshold));
